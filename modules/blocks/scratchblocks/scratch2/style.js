  ...
  static makeHighContrastIcons() {
    ...
    return [
      ...
      SVG.setProps(
        ...
        {
          id: "sb2-dropdownArrow-high-contrast",
          transform: "scale(0.944)",
        },
      ),
      ...
      SVG.setProps(
        ...
        {
          id: "sb2-turnRight-high-contrast",
        },
      ),
      SVG.setProps(
        SVG.group([
      ...
      SVG.setProps(
        ...
        {
          id: "sb2-loopArrow-high-contrast",
        },
      ),
      ...
      SVG.setProps(
        ...
        {
          id: "sb2-musicBlock-high-contrast",
          fill: "none",
        },
      ),
      SVG.setProps(
      ...
      SVG.setProps(
        ...
        {
          id: "sb2-videoBlock-high-contrast",
          stroke: "#0b8e69",
          fill: "#FFF",
          "stroke-opacity": 0.15,
        },
      ...
      SVG.el("image", {
        id: "sb2-translateBlock-high-contrast",
        width: "40px",
        height: "40px",
